...
export var SpecialKeysButton = document.getElementById("specialKeysButton") as HTMLButtonElement;
export var SpecialKeysMenu = document.getElementById("specialKeysMenu") as HTMLDivElement;
